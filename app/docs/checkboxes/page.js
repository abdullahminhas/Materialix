    ...
    <React.Fragment>
      <div className="flex gap-x-2 mt-4 px-2">
        <div className="w-1/2">
          <Card className="flex justify-center border-0 min-h-[544px]">
            <CardContent>
              <h1 className="text-8xl font-medium">Checkbox</h1>
        ...
        <div className="w-1/2">
          <div
            className="flex justify-center w-full h-full bg-cover! rounded-xl"
            style={{
              background:
                "url(https://lh3.googleusercontent.com/3pONGTFiKHeHqRQvp4qt0epYpDyXQiA51Nt1wFPcwcro56d8FHGjz3vw_qaW2pCqlGjbpnAFXWXekmUXMDN8oyMdRg9LsmPVTLjDzRcOLc4jnbY5-e3S=w1800-rj)",
            }}
          >
            <img
              className="w-3/4 object-fit"
              src="https://lh3.googleusercontent.com/ympLdvKr2taAMS7v9HEsfvDVcY-1vWRQIsCSip_ZVlvijzks4tlEbjK-6ewx2-FeNKVtzkZTJmwPx5sjTsG2Pny1MncB_oO9FFyjxxxzCO5tjAliJ40=w1800"
            />
          </div>
        </div>
      </div>
      <div className="container mx-auto">
        <Card className="mt-10 mb-3">
          <CardContent className="flex flex-row justify-around gap-x-8">
